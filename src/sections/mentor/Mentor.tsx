...
const Mentor = () => {
    return(
        <section className="px-4 lg:px-32 mt-4 lg:mt-32">
            <div className="text-center pb-16 w-full">
                <h1 className="text-3xl lg:text-6xl font-black tracking-tight text-neutral-900">
                To Our Mentors & Guides.
                </h1>
                <div className="w-full h-fit flex justify-center">
                    <div className="max-w-250">
                        <h3 className="text-xs lg:text-2xl font-medium text-neutral-500 py-3 lg:py-6 wrap-break-words">
            ...
            <div className="mb-8 lg:my-16 rounded-2xl h-fit p-4 lg:p-12 shadow-xl border-neutral-100 border-2">
                <h1 className="text-[8px]  lg:text-2xl font-medium leading-relaxed bg-linear-to-r from-[#2249CA] to-[#C15E20] bg-clip-text text-transparent">
                ...
                <div className="flex justify-between mt-6 lg:mt-24 items-center">
                    <div className="flex gap-2 lg:gap-5">
                        <div className="w-fit h-fit p-2 lg:p-3 rounded-full bg-linear-to-r from-[#2249CA] to-[#C15E20]">
                            <ChatTeardropTextIcon className="w-4 h-4 lg:h-8 lg:w-8" color="white" weight="fill"/>
                        </div>
                        <div className="w-fit h-full mt-1">
                            <h1 className="tracking-tight text-neutral-900 text-[8px] lg:text-lg font-bold">
                                With Love & Respect
                            </h1>
                            <h3 className="font-medium text-neutral-400 text-[8px] lg:text-lg">
                    ...
                    <div className="avatar-group -space-x-4 lg:-space-x-6">
                        ...
                        <div className="avatar avatar-placeholder border-white">
                            <div className="bg-linear-to-r from-[#2249CA] to-[#C15E20] text-neutral-content w-8 lg:w-12 font-semibold lg:font-bold">
